...
def initialize_debug_stream(reinitialize=False):
    ...
    if (
        reinitialize
        and not _LoggingGlobals._debug_stream_initialized
        or not reinitialize
        and _LoggingGlobals._debug_stream_initialized
    ):
        return
    ...
    if not DebugInfoHolder.PYDEVD_DEBUG_FILE:
        ...
        try:
            ...
            debug_file = os.path.join(dirname, f'{name}.{str(os.getpid())}{ext}')
