...
def create_editor_hook(pydev_host, pydev_client_port):
    ...
    def call_editor(filename, line=0, wait=True):
        ...
        server = xmlrpclib.Server(f'http://{pydev_host}:{pydev_client_port}')
...
class PyDevTerminalInteractiveShell(TerminalInteractiveShell):
    ...
    def init_completer(self):
        ...
        if IPythonRelease._version_major <= 3 and self.has_readline:
...
class _PyDevFrontEnd:
    ...
    def getCompletions(self, text, act_tok):
        ...
        try:
            ...
            append = ret.append
            ip = self.ipython
            pydev_completions = {f[0] for f in ret}
