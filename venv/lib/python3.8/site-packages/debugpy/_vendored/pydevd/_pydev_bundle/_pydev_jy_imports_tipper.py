...
class Info:
    ...
    def __init__(self, name, **kwargs):
        ...
        self.varargs = kwargs.get('varargs')
    ...
    def basic_as_str(self):
        ...
        '''
        args = self.args
        return f'function:{self.name} args={args}, varargs={self.varargs}, kwargs={self.kwargs}, docs:{self.doc}'
...
def dir_obj(obj):
    ...
    # charAt don't appear)
    d = dir(original)
    ret.extend(name for name in d if found.get(name) != 1)
    return ret
