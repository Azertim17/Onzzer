...
class PydevTestResult(_PythonTextTestResult):
    ...
    def addSubTest(self, test, subtest, err):
        ...
        if err is not None:
            ...
            self._reportErrors([error], [], '', f'{self.get_test_name(test)} {subdesc}')
    ...
    def startTest(self, test):
        ...
        try:
            ...
            test_name = f"{test.__class__.__name__}.{test._TestCase__testMethodName}"
        ...
        try:
            try:
                ...
                try:
                    ...
                    test_name = f'{test.description.split()[1][1:-1]} <{test.description.split()[0]}>'
        except:
            traceback.print_exc()
    ...
    def stopTest(self, test):
        ...
        skipped = False if outcome is None else bool(getattr(outcome, 'skipped', None))
        if skipped:
